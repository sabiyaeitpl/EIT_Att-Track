                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Project Name 1',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400,fontSize: 25.sp),),
                            Text('${Translation.of(context)!.translate('assign_date')!}: 01-10-2023',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400,fontSize: 16.sp),),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: SizedBox(
                          child: Column(
                            children: [
                              ...
                              Row(
                                children: [
                                  Text(Translation.of(context)!.translate('project_details')!,style: TextStyle(fontSize: 18.sp,fontWeight: FontWeight.w400),),
                                ],
                              ),
                              SizedBox(height: 5.h,),
                              Container(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Center(
                                              child: FittedBox(child: Text('In Progress',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400,fontSize: 25.sp),)),
                                            ),
                                          ),
                                        ),
                                        PopupMenuButton(
