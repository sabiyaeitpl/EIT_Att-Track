...
class _HomeProfileSectionState extends State<HomeProfileSection> {
  ...
  getSharedPreferencesData()async{
    context.read<AttendanceProvider>().setEmpName();
    context.read<AttendanceProvider>().setDesignation();
    context.read<AttendanceProvider>().setEmpImage();
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Container(width:200.w,child: FittedBox(child: Text('${AttendanceProviderInstance.empName}',style: TextStyle(color: Colors.black,fontSize: 25.sp),))),
                            Container(width:200.w,child: FittedBox(child: Text('${AttendanceProviderInstance.designation}',style: TextStyle(color: Colors.black,fontSize: 20.sp),maxLines: 2,))),
                          ],
                        )
                      ],
                    ),
